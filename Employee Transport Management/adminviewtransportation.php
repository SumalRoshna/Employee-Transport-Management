...
<section id="contact" class="contact">
    <div class="container">
        <form action="" method="post">
            <input type="search" name="search" id="" style="width: 500px; background-color:#F7F5F3">
            <input type="submit" name="submit" value="Search" style="width: 100px; background-color:#273746; color:#fff">
        </form>
        <?php
